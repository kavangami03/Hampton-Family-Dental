    ...
    <main className="bg-white overflow-hidden font-body text-navy">
      ...
      <section className="relative pt-36 pb-20 md:pt-44 md:pb-24 bg-navy-dark text-white">
        ...
        <div className="relative z-10 max-w-[1300px] mx-auto px-5 md:px-10">
          ...
          {/* Quick Stats Grid */}
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 max-w-4xl mt-12 pt-8 border-t border-white/10">
            <div className="p-3 bg-white/5 rounded-2xl border border-white/10 md:col-span-1">
            ...
            <div className="p-3 bg-white/5 rounded-2xl border border-white/10 md:col-span-3">
